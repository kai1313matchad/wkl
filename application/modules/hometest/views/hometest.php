...
<head>
    <!-- Page Title -->
    <title>Wiklan | Situs Belanja Online Media Iklan Indoor dan Outdoor | Advertising Indonesia</title>
    <!-- Meta Tags -->
    <meta charset="utf-8">
    ...
    <!-- Theme Styles -->
    <link rel="stylesheet" href="<?= site_url()?>marketplace/travelo/html/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?= site_url()?>marketplace/travelo/html/css/font-awesome.min.css">
    <link href='http://fonts.googleapis.com/css?family=Lato:300,400,700' rel='stylesheet' type='text/css'>
    <link rel="stylesheet" href="css/animate.min.css">
    <!-- Current Page Styles -->
    <link rel="stylesheet" type="text/css" href="<?= site_url()?>marketplace/travelo/html/components/revolution_slider/css/settings.css" media="screen" />
    <link rel="stylesheet" type="text/css" href="<?= site_url()?>marketplace/travelo/html/components/revolution_slider/css/style.css" media="screen" />
    <link rel="stylesheet" type="text/css" href="<?= site_url()?>marketplace/travelo/html/components/jquery.bxslider/jquery.bxslider.css" media="screen" />
    <link rel="stylesheet" type="text/css" href="<?= site_url()?>marketplace/travelo/html/components/flexslider/flexslider.css" media="screen" />
    <!-- Main Style -->
    <link id="main-style" rel="stylesheet" href="<?= site_url()?>marketplace/travelo/html/css/style.css">
    <!-- Custom Styles -->
    <link rel="stylesheet" href="<?= site_url()?>marketplace/travelo/html/css/custom.css">
    <!-- Updated Styles -->
    <link rel="stylesheet" href="<?= site_url()?>marketplace/travelo/html/css/updates.css">
    <!-- Responsive Styles -->
    <link rel="stylesheet" href="<?= site_url()?>marketplace/travelo/html/css/responsive.css">
    <!-- CSS for IE -->
    <!--[if lte IE 9]>
...
<body>
          ...
          <div class="container">
            <h1 class="logo2 navbar-brand">
              <a href="index.html" title="Travelo - home">
                <img src="<?= site_url()?>marketplace/travelo/html/images/logo.png" alt="Travelo HTML5 Template" />
              </a>
            </h1>
          ...
          <div class="fullwidthbanner-container">
            ...
            <!-- SLIDE  -->
              <ul>
                ...
                <!-- MAIN IMAGE -->
                  <img src="<?= site_url()?>marketplace/banner/banner1.png" alt="">
                </li>
                <!-- Slide2 -->
                <li data-transition="zoomout" data-slotamount="7" data-masterspeed="1500">
                <!-- MAIN IMAGE -->
                  <img src="<?= site_url()?>marketplace/banner/banner3.png" alt="">
                </li>
                <!-- Slide3 -->
                <li data-transition="slidedown" data-slotamount="7" data-masterspeed="1500">
                <!-- MAIN IMAGE -->
                  <img src="<?= site_url()?>marketplace/banner/banner8.jpg" alt="">
                </li>
              </ul>
            </div>
          </div>
        ...
        <div class="global-map-area section parallax" data-stellar-background-ratio="0.5">
          <div class="container description text-center">
            ...
            <div class="travelo-process">
              <img src="<?= site_url()?>marketplace/travelo/html/images/travelo_process.png" alt="">
              ...
              <div class="flex-viewport" style="overflow: hidden; position: relative;">
                <ul class="slides image-box style9" style="width: 1400%; transition-duration: 0s; transform: translate3d(-200px, 0px, 0px);">
                  <li style="width: 170px; float: left; display: block;">
                    <article class="box">
                      <figure>
                        <a href="hotel-list-view.html" title="" class="hover-effect yellow"><img src="http://placehold.it/170x160" alt="" width="170" height="160" draggable="false"></a>
                      </figure>
                      <div class="details">
                  ...
                  <div class="row1">
                    ...
                    <div class="investor-slideshow image-carousel style2 investor-list" data-animation="slide" data-item-width="170" data-item-margin="30">
                        ...
                        <ul class="slides" style="width: 1200%; transition-duration: 0.6s; transform: translate3d(0px, 0px, 0px);">
    	                    <li style="width: 170px; float: left; display: block;">
                            <div class="travelo-box">
                              <a href="#"><img src="http://placehold.it/160x60" alt="" draggable="false"></a>
                            </div>
                          </li>
    	                    <li style="width: 170px; float: left; display: block;">
                            <div class="travelo-box">
              ...
              <div class="row">
                ...
                <div class="col-sm-6 col-md-3">
                  ...
                  <ul class="travel-news">
                    <li>
                      <div class="thumb">
                        <a href="#"><img src="http://placehold.it/63x63" alt="" width="63" height="63" /></a>
                      </div>
          ...
          <div class="bottom gray-area">
            <div class="container">
              <div class="logo pull-left">
                <a href="index.html" title="Travelo - home"><img src="<?= site_url()?>marketplace/travelo/html/images/logo.png" alt="Travelo HTML5 Template" /></a>
              </div>
    ...
    <!-- Javascript -->
    <script type="text/javascript" src="<?= site_url()?>marketplace/travelo/html/js/jquery-1.11.1.min.js"></script>
    <script type="text/javascript" src="<?= site_url()?>marketplace/travelo/html/js/jquery.noconflict.js"></script>
    <script type="text/javascript" src="<?= site_url()?>marketplace/travelo/html/js/modernizr.2.7.1.min.js"></script>
    <script type="text/javascript" src="<?= site_url()?>marketplace/travelo/html/js/jquery-migrate-1.2.1.min.js"></script>
    <script type="text/javascript" src="<?= site_url()?>marketplace/travelo/html/js/jquery.placeholder.js"></script>
    <script type="text/javascript" src="<?= site_url()?>marketplace/travelo/html/js/jquery-ui.1.10.4.min.js"></script>
    
    <!-- Twitter Bootstrap -->
    <script type="text/javascript" src="<?= site_url()?>marketplace/travelo/html/js/bootstrap.js"></script>
    
    <!-- load revolution slider scripts -->
    <script type="text/javascript" src="<?= site_url()?>marketplace/travelo/html/components/revolution_slider/js/jquery.themepunch.plugins.min.js"></script>
    <script type="text/javascript" src="<?= site_url()?>marketplace/travelo/html/components/revolution_slider/js/jquery.themepunch.revolution.min.js"></script>

    <!-- Flex Slider -->
    <script type="text/javascript" src="<?= site_url()?>marketplace/travelo/html/components/flexslider/jquery.flexslider-min.js"></script>
    
    <!-- load BXSlider scripts -->
    <script type="text/javascript" src="<?= site_url()?>marketplace/travelo/html/components/jquery.bxslider/jquery.bxslider.min.js"></script>
    
    <!-- parallax -->
    <script type="text/javascript" src="<?= site_url()?>marketplace/travelo/html/js/jquery.stellar.min.js"></script>
    
    <!-- waypoint -->
    <script type="text/javascript" src="<?= site_url()?>marketplace/travelo/html/js/waypoints.min.js"></script>

    <!-- load page Javascript -->
    <script type="text/javascript" src="<?= site_url()?>marketplace/travelo/html/js/theme-scripts.js"></script>
    <script type="text/javascript" src="<?= site_url()?>marketplace/travelo/html/js/scripts.js"></script>
    ...
    <script type="text/javascript">
      ...
      if (enableChaser == 1 && tjq('#content').length > 0 && tjq('#main-menu ul.menu').length > 0) {
        ...
        tjq('<h1 class="logo navbar-brand"><a title="Travelo - home" href="index.html"><img alt="" src="<?php echo base_url()?>marketplace/travelo/html/images/logo.png"></a></h1>').insertBefore('.chaser .menu');
